...
function usage() {
    ...
    -p the array of run precison, default is "bfloat16", eg: [-p "bfloat16 woq_int8"].
    -b the array of run batch_size, default is "1", eg: [-b "1 2 4 8"].
    -c the array of core, default is "56", eg: [-c "50 52 54 56"].
    -f the array of frequencys, default is "3.8", eg: [-f "2.0 2.4 2.8 3.8"].
...
function run_with_n_cores(){
    ...
    do
        ...
        do   
            ...
            if [[ $DRY_RUN ]]; then
                echo "Current {$i}-${CORE}-${FREQUENCY}-${PRECISION}-${BATCH_SIZE}"
    ...
    do
        ...
        do
            if [[ ${HARDWARE_PLATFORM} == "emr" ]]; then
                ...
                output_log=${output_dir}/c_${PRECISION}_${BATCH_SIZE}.log
                ...
                do
                    ...
                    output_log=${output_dir}/c_${PRECISION}_${BATCH_SIZE}_${CORE}.log
